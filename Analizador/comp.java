...
class comp implements compConstants {
  ...
  static final public void VariablesGlobales() throws ParseException {System.out.println("" + token.image + ",Posicion: " + token.beginLine + ", " + token.beginColumn);
...
//Sentencia IF
  static final public void SentenciaIf() throws ParseException {System.out.println("Posicion: " + token.beginLine + ", " + token.beginColumn);
        TokenAsignaciones.SetTables();
    jj_consume_token(IF);
  ...
  static final public void Sino() throws ParseException {System.out.println("Posicion: " + token.beginLine + ", " + token.beginColumn);
        TokenAsignaciones.SetTables();
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case ELSE:{
  ...
  static final public void A() throws ParseException {System.out.println("Posicion: " + token.beginLine);
        TokenAsignaciones.SetTables();
    Comparaciones();
    label_6:
    while (true) {
...
//Fin sentencia if
  static final public 
void Comparaciones() throws ParseException {System.out.println("Posicion: " + token.beginLine + ", " + token.beginColumn);
        TokenAsignaciones.SetTables();
    Valor();
    Operadores();
    Valor();
  ...
  static final public void Expresion() throws ParseException {System.out.println("Posicion: " + token.beginLine + ", " + token.beginColumn);
        TokenAsignaciones.SetTables();
    if (jj_2_5(2)) {
      switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
      case NUMBER:{
  ...
  static final public int OpAritmetico() throws ParseException {System.out.println("Posicion: " + token.beginLine + ", " + token.beginColumn);
        TokenAsignaciones.SetTables();
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case PLUS:{
...
{if ("" != null) return 0;}
  ...
  static final public void TiposDatos() throws ParseException {TokenAsignaciones.SetTables();
        if(token.kind == 44){
...
//Sentencia FOR
  static final public void SentenciaFor() throws ParseException {System.out.println("Posicion: " + token.beginLine + ", " + token.beginColumn);
        TokenAsignaciones.SetTables();
...
//Sentencia DO
  static final public void SentenciaDo() throws ParseException {System.out.println("Posicion: " + token.beginLine + ", " + token.beginColumn);
        TokenAsignaciones.SetTables();
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case DO:{
      jj_consume_token(DO);
  ...
  static final public void SentenciaWhile() throws ParseException {System.out.println("Posicion: " + token.beginLine + ", " + token.beginColumn);
        TokenAsignaciones.SetTables();
    jj_consume_token(WHILE);
    jj_consume_token(LPAREN);
    Comparaciones();
...
//Sentencia READ
  ...
  static final public void SentenciaSwitch() throws ParseException {System.out.println("Posicion: " + token.beginLine + ", " + token.beginColumn);
        TokenAsignaciones.SetTables();
